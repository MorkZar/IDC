...
<body>
    ...
    <nav class="navbar">
        ...
        <!-- Logo -->
        <div class="logo">
            <img src="imagenes/logo ReservaTec (1).png" alt="ReservaTec">
        </div>

        <!-- Botones -->
        <div class="nav-buttons">
            <button class="button1" onclick="location.href='mainpage.php'">
                <svg
                  height="24"
                  width="24"
                  viewBox="0 0 24 24"
            ...
            <button class="button1" onclick="location.href='peticiones.php'">
                  ...
                  <span>Solicitar Petición</span>
                  </button>
        </div>

        <!-- Usuario -->
        <div class="user-menu">
            <img src="imagenes/usuario.png" alt="Usuario" class="user-icon" id="userMenuButton">
    ...
    <section class="description">
        <h1>Bienvenido a ReservaTec</h1>
        <p>Es un sitio web que te facilitara la reservación de espacios dentro del edificio de vinculación para diversos eventos.</p>
    </section>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            userMenuButton.addEventListener("click", function (event) {
                event.stopPropagation(); // Evita que el clic en el botón lo cierre
